	...
	<div class="row" style="margin-top:40px;">
    	...
    	<div class="well well-sm">
            ...
            <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                    <form accept-charset="UTF-8" action="reviewAction.jsp" method="post">
                        ...
                        <div class="text-right">
                            ...
                            <button class="btn btn-success btn-lg" type="submit" id="save-box">Save</button>
                        </div>
                    </form>
                </div>
            </div>
