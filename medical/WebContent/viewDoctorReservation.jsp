...
<ul class="menu_4_content">  
  ...
  ArrayList<Reservation> list = reservationDAO.ReservationList2(Dnumber);
...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
            ...
            %>
            <td><a href="comment.jsp?reser_id=<%=list.get(i).getId()%>&day=<%=allday%>&name=<%=list.get(i).getUserId() %>">입장</a></td>
            <%}else{ %>
            <td>-</td>
            <%} %>
