...
session.setAttribute("hname", hospitalName);
...
<ul class="menu_4_content">  
  ...
  <div class="conB"> <div class="conB_title"> 
	...
	<!-- 로긴폼 -->	
		<div class="containerXX" style="width:1000px;margin: 0 auto;">
		<div class="col-lg-4"></div>
		<div class="col-lg-4">
		<!-- 점보트론 -->
		<div class="jumbotron" style="width:700px;margin: 0 auto;padding-top: 20px;">
		<!-- 로그인 정보를 숨기면서 전송post -->
